...
trait Model [V, R, E] {
  ...
  def applyUnsafe (r: R): V = apply (r) fold (e => throw new IllegalArgumentException (e.toString), identity)
...
object Model {
  ...
  def subtype [A, B, E, R] (submodel: Model [A, R, E], supermodel: Model [B, R, E]): Model [A, B, E] =
    Model instance (
